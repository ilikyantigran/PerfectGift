...
// httpSource fetches a JWKS document over HTTP from Identity's JWKS endpoint. The
// Verifier caches the result and tolerates transient fetch failures by serving the
// last-known key set.
